...
public class AllMyOrders extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // nacitanie vsetkych ziadosti, ktore vytvoril
        // aktualny pouzivatel do listov (objednavka aby mu niekto nieco kupil)
        for(OrdersModel order : ordersList.listOfRequests){
        ...
        // naplnenie listView ziadostami, ktore vytvoril aktualny pouzivatel
        ...
        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(AllMyOrders.this, MyOrderPreview.class);
